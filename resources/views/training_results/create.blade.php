        ...
        <div class="col-span-1 p-4">
          ...
          <div id="equipments">
            ...
            <div class="equipments flex">
              ...
              <input type="text" name="equipments[{{$i}}][name]" placeholder="器具名" class="equipments-name border border-gray-300 p-2 mb-4 w-full rounded">
              :
              <input type="text" name="equipments[{{$i}}][wheight]" placeholder="重量" class="equipments-wheight border border-gray-300 p-2 mb-4 w-full rounded">
